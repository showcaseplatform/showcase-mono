...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "email", "name", "profile"],
  ...
  UserCreateInput: ["id", "email", "name", "profile"],
  UserUpdateInput: ["id", "email", "name", "profile"],
...
const outputsInfo = {
  ...
  ProfileGroupBy: ["id", "bio", "userId", "count", "min", "max"],
  AggregateUser: ["count", "min", "max"],
  UserGroupBy: ["id", "email", "name", "count", "min", "max"],
